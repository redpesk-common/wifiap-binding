...
-- This tests 'setIeeeStandard wrong IEEE Standard bit mask value'
_AFT.testVerbStatusError(testPrefix.."set_wrong_ieee_standard_value",api,"setIeeeStandard",128, nil, nil)
_AFT.testVerbStatusError(testPrefix.."set_wrong_ieee_standard_value",api,"setIeeeStandard",32, nil, nil)
